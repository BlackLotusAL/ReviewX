...
export function Markdown({ children, className = "markdown" }: { children: string; className?: string }) {
  return <div className={className}><ReactMarkdown skipHtml remarkPlugins={[remarkGfm, remarkBreaks]} rehypePlugins={[rehypeSanitize]} allowedElements={markdownElements} urlTransform={safeMarkdownUrl}
    components={{
