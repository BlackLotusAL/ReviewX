...
const failure: SafeErrorView = { code: "REVIEW_INCOMPLETE", message: "检视失败。", cause: "必要调用方未取得。", impact: "本次不生成可处理意见或 PASS。", nextStep: "补齐上下文后重新检视。", technicalDetails: "Verification context unavailable." };
